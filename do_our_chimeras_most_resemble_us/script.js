...
chargerLogo('logo/logo_pompidou.svg', document.getElementById('logo-pompidou'), 'https://www.https://newmedia-art.org/');
...
function buildAboutContent(lang) {
  ...
  if (lang === "FR") {
    ...
    el.innerHTML = `
      ...
      <div id="about-links">
        <a href="https://kadist.org" target="_blank">https://www.kadist.org</a>
        <a href="https://www.newmedia-art.org" target="_blank">https://www.newmedia-art.org</a>
      </div>
