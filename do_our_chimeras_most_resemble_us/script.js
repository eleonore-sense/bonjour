...
text: `Agnieszka Polska’s <span class="titre-oeuvre">The Book of Flowers</span> imagines an alternate world of speculative fiction in which humans and flowering plants co-evolve through deep symbiosis. Using AI-generated animation to overwrite 16mm time-lapse footage of blooming flowers, she transforms archival scientific imagery that once reshaped how the wider public perceived the movement of plants. Integrating human bodies into botanical cycles, Polska’s narrative inverts gender hierarchies while highlighting ecological awareness. 
...
text: `Jonas Lund’s <span class="titre-oeuvre">The Future of Life</span> stages immortality as a corporate product launch, where an AI promises to “make all the right decisions” so humans can “enjoy eternity,” even as internal politics and emotions threaten the rollout. Lund’s premise is quintessentially chimeric: the oldest human aspiration (endless life) braided to the newest managerial dogma (optimization). <span class="italic_style">The Future of Life</span> is part of the <span class="italic_style">The Future of</span> series by Lund on humanity’s relationship with AI, following <span class="italic_style">The Future of Nothing</span> and <span class="italic_style">The Future of Something</span>, both from 2023. Each film is made in close collaboration with a range of different generative AIs, highlighting the rapid changes in visual credibility.
...
textFR: `Dans <span class="titre-oeuvre">The Future of Life</span>, l’artiste Jonas Lund met en scène l’immortalité comme un nouveau produit lancé par une entreprise. Une IA promet de «prendre toutes les bonnes décisions» afin que les humains puissent «\u202fprofiter de l’éternité\u202f», alors même que des luttes de pouvoir internes et les émotions des personnages menacent le déploiement du projet. Le postulat de Lund est par excellence chimérique\u202f: la plus ancienne aspiration humaine (la vie éternelle) s’entremêle avec le dogme managérial le plus récent (l’optimisation). <span class="italic_style">The Future of Life</span> fait partie de la série <span class="italic_style">The Future of</span> que Lund consacre à la relation de l’humanité à l’IA, après <span class="italic_style">The Future of Nothing</span> et <span class="italic_style">The Future of Something</span>, tous deux datant de 2023. Chaque film est réalisé en étroite collaboration avec toute une gamme d’IA génératives, mettant en évidence l’évolution rapide de leurs performances en matière de crédibilité visuelle.
...
<credits>Courtesy the artist and BLOOM</credits>`,  },
  ...
  6: {
    ...
    bioTitreFr: "Emmanuel Van der Auwera (né en 1982, Belgique)",
    titre: "The Gospel",
...
text: `<span class="titre-oeuvre">The Gospel</span> by Emmanuel Van der Auwera explores the unstable boundary between belief, mediation, and power. Working with photogrammetry and generated images tracing contemporary technologies and their intervention into social life, Van der Auwera points to how data analysis and systems of control are produced by AI, marking a pivotal moment, “...the first time that AI selected targets without human intervention.” In this video, the “gospel” is described as a surveillance technology, displaced from the sacred into the political, where images acquire power and inform networks of control—a new faith is born in the technology itself. That faith extends to intimate relationships with AI, and is contrasted with vignettes of a Chinese miner searching for rare earth minerals used in various technologies, including the GPUs that power LLMs. 
<bio>
...
<bio>Emmanuel Van der Auwera est un artiste belge dont le travail explore la production et la consommation des images au sein d’une nouvelle économie visuelle façonnée par l’espace numérique, ainsi que les enjeux éthiques du regard. Sa pratique s’articule autour de la chaîne qui va de l’extraction des matières premières à l’image finale\u202f: les mines fournissant les terres rares, les chaînes d’approvisionnement et les régimes de travail liés à la fabrication des appareils, les plateformes qui diffusent les contenus visuels, et les spectateurs qui les consomment sans percevoir cette infrastructure. En rendant ces liens visibles, son œuvre interroge : que signifie être complice d’un système de création d’images dont les conditions matérielles sont délibérément maintenues hors champ\u202f? Il est lauréat du prix Langui 2015 dans le cadre du Young Belgian Art Prize et premier lauréat du Goldwasserschenking, décerné par le WIELS Contemporary Art Centre. Ses œuvres ont notamment été exposées au Palais de Tokyo à Paris, à la Pinakothek der Moderne à Munich, et à l’Institut KW pour l’art contemporain à Berlin.</bio>
<credits>Courtesy of Harlan Levey Projects and the artist</credits>
`,  },
...
text: `
Ho Tzu Nyen’s <span class="titre-oeuvre">P for Power</span> was commissioned by Bozar as part of his ongoing <span class="italic_style">Critical Dictionary of Southeast Asia</span>. This video installation unfolds as “30 real-time edited chapters,” each a Q&A between Ho and an AI chatbot attempting to define “Power.” The chatbot becomes a contemporary oracle—verbose, confident, derivative—whose authority is inseparable from its statistical nature. By staging Singaporean children as protagonists who infiltrate found footage from the internet, Ho engages an open-ended question as to the many possible uses and definitions of power in the future. In the artist’s words, “\u202fPower, not as domination, but as endurance, consistency, coherence over temporal extension.\u202f” Originally fed through a live internet input, <span class="italic_style">P for Power</span> is proposed here as three generated iterations alternating through the duration of the exhibition.
...
function setCalendarVisible(visible) {
  ...
  if (visible) {
    ...
    setOpacity(boiteCalendar, '1', '1.5s');
        if (label) setOpacity(label, '1', '1.5s');
  } else {
...
const creditsData = {
  FR: {
    ...
    kadistRoles: [
      ...
      { role: "Directrice de la communication", names: "Caroline Arce Ross" },
...
function buildAboutContent(lang) {
  ...
  if (lang === "FR") {
    el.innerHTML = `
      ...
      <p>Nos utopies et nos cauchemars ont toujours été chimériques — des composites de l'état d'esprit du présent, évoquant tout ce que nous pourrions un jour imaginer, mais que nous ne pouvons encore visualiser. Ce que font ces systèmes, c'est rendre le texte et l'image des composantes fluides d'un régime de données sans origine ni référent précis. Dans <span class="italic_style">L'Iliade</span>, la chimère est décrite comme «\u202fune chose d'une fabrication immortelle, non humaine, lion devant, serpent derrière, chèvre au milieu\u202f». Ce qui frappe, c'est la grammaire de la bête\u202f: c'est une conjonction, une syntaxe élargie. Il y a un «\u202fet-et\u202f» là où il devrait y avoir un « ou ». Les systèmes génératifs partagent cette logique. Plutôt que de choisir entre des références, entre des styles, les grands modèles de langage produisent une image qui est à la fois lion, serpent et chèvre, combinant ce qui, selon les lois naturelles, devrait rester distinct. Le résultat réel ressemble davantage à un palimpseste\u202f: de nombreux textes et images à la fois, aucun n'étant tout à fait lisible. Pourtant, ils émergent de l'abîme mythique de l'oracle pour s'imposer dans un présent immaculé, en haute résolution.</p>
      ...
      <div id="about-links">
        <a href="https://www.kadist.org" target="_blank">kadist.org</a>
        <a href="https://www.centrepompidou.fr/fr/" target="_blank">centrepompidou.fr</a>
      </div>
    ...
    el.innerHTML = `
      ...
      <p>Our utopias and our nightmares have always been chimaeric — composites of the present mindset, conjuring everything we might one day imagine but cannot yet visualize. LLMs and AI systems render text and image as fluid components of a data-regime without a specific origin or referent. In <span class="italic_style">The Iliad</span>, the chimera is rendered as a "thing of immortal make, not human, lion in front, serpent behind, goat in the middle." What is striking is the grammar of the beast: it is a conjunction, an expanded syntax. There's "and-and" where there should be an "or." Generative systems share this logic. Rather than deliberate between references, between styles, LLMs produce an image that is lion-and-serpent-and-goat, combining what should by natural law remain discrete. The actual result is something closer to palimpsest: many texts and images at once, none of them quite legible. And they emerge from the mythic abyss of the black box into the pristine, high-resolution present.</p>
...
function buildCredits(lang) {
  ...
  const colon = lang === 'FR' ? ' :' : ':'; // ← ajout : espace avant ':' en FR seulement
  ...
  d.roles.forEach(item => {
    html += `
      <div class="credit-block">
        <span class="credit-role">${item.role}${colon}</span><span class="credit-names">${formatNames(item.names)}</span>
      </div>
    `;
  });
  ...
  html += `
    <div class="credit-block">
      <span class="credit-role">${lang === 'FR' ? 'Graphisme et développement web' : 'Graphism and web development'}${colon}</span><span class="credit-names"><a href="https://eleonore-sense.github.io/bonjour/" target="_blank">Eléonore Sense</a></span>
    </div>
    <div class="credit-block">
      <span class="credit-role">${lang === 'FR' ? 'Typographie de titrage' : 'Display typeface'}${colon}</span><span class="credit-names">Lagarto ${lang === 'FR' ? 'de' : 'by'} <a href="https://www.sudtipos.com/font/lagarto" target="_blank">Sudtipos</a></span>
    </div>
    <div class="credit-block">
      <span class="credit-role">${lang === 'FR' ? 'Typographie de labeur' : 'Body typeface'}${colon}</span><span class="credit-names">${lang === 'FR' ? `Abordage de <a href="https://www.eugéniebidaut.eu/" target="_blank">Eugénie Bidaut</a> d'après <a href="https://velvetyne.fr/degheest/fr.html" target="_blank">Ange Degheest</a>.` : `Typography by <a href="https://www.eugéniebidaut.eu/" target="_blank">Eugénie Bidaut</a>, based on the work of <a href="https://velvetyne.fr/degheest/fr.html" target="_blank">Ange Degheest</a>.`}</span>
    </div>
  `;
