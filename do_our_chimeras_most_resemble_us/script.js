...
function buildAboutContent(lang) {
  ...
  if (lang === "FR") {
    ...
    el.innerHTML = `
      ...
      <p>Our utopias and our nightmares have always been chimaeric — composites of the present mindset, conjuring everything we might one day imagine but cannot yet visualize. LLMs and AI systems render text and image as fluid components of a data-regime without a specific origin or referent. In <span id="italic_style">The Iliad</span>, the chimera is rendered as a "thing of immortal make, not human, lion in front, serpent behind, goat in the middle." What is striking is the grammar of the beast: it is a conjunction, an expanded syntax. There's "and-and" where there should be an "or." Generative systems share this logic. Rather than deliberate between references, between styles, LLMs produce an image that is lion-and-serpent-and-goat, combining what should by natural law remain discrete. The actual result is something closer to palimpsest: many texts and images at once, none of them quite legible. And they emerge from the mythic abyss of the black box into the pristine, high-resolution present.</p>
